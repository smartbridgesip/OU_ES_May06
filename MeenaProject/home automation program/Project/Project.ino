...
LiquidCrystal lcd(4,5,18,19,22,23);

#include <ThingSpeak.h> 

const char* ssid     = "Pujitha";
const char* password = "pujithav";

WiFiClient client;  
unsigned long myChannelNumber = 787440;  
const char * myWriteAPIKey = "CZ2RKH1I6A28JPZD";  
...
ThingSpeak.writeField(myChannelNumber, 1, temp_celsius, myWriteAPIKey);

ThingSpeak.writeField(myChannelNumber, 2, temp_fahrenheit, myWriteAPIKey); 
